...
<div class="row">
    <div class="col-12 col-lg-8 mx-auto">
        <div class="d-flex flex-row justify-content-between">
            ...
            <form action="{{ route('profile.listing.destroy', $product) }}" method="POST" class="form-inline">
                @method('DELETE')
                @csrf
                ...
                <div class="row">
                    @foreach ($product->images as $image)
                        <div class="col-sm-12 col-lg-4 mb-2">
                            ...
                            <form method="POST" action="{{ route('profile.image.destroy', $image) }}">
                                @method('DELETE')
                                @csrf
                ...
                @if ($product_images < 3)
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            @enderror
                            <form method="POST" action="{{ route('profile.image.store', $product) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
        ...
        <form method="POST" action="{{ route('profile.listing.update', $product) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-sm-12 col-lg-3">
