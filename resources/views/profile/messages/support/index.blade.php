    ...
    <div class="col-12 col-lg-8 mx-auto">
        ...
        @if ($threads->count() > 0)
            <div class="list-group">
                @forelse($threads as $thread)
                    ...
                    <a href="{{ route('profile.support.show', $thread) }}" class="list-group-item list-group-item-action">
        ...
        @else
            <div class="alert alert-secondary" role="alert">
                ...
                <p class="mb-0">For assistance, you can contact our customer <a href="{{ route('profile.support.create') }}" class="alert-link">support center</a> for assistance.</p>
            </div>
        @endif
    </div>
