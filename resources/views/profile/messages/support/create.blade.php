...
<div class="row d-flex justify-content-center">
    <div class="col-sm-12 col-lg-8">
        ...
        <form method="POST" action="{{ route('profile.support.store') }}">
            @csrf
            ...
            <a href="{{ route('profile.support.index') }}" class="btn btn-outline-secondary m-2" role="button" aria-pressed="false">Cancel</a>
        </form>
    </div>
</div>
@endsection