    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Creating new listing</h1>
                    </div>
                </div>
            </div>
        </section>
        <section class="content">
            <form method="POST" action="{{ route('profile.listings.store') }}" class="w-100" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="1" min="1" id="inputQuantity" name="quantity" value="{{ old('quantity') }}" class="form-control @error('quantity') is-invalid @enderror">
                                </div>
                                <div class="form-group">
                                    <label for="inputMoq">Minimum order quantity</label>
                                    <input type="number" step="1" min="1" id="inputMoq" name="moq" value="{{ old('moq') }}" class="form-control @error('moq') is-invalid @enderror">
                                </div>
                                <div class="form-group">
                                    <label for="inputPrice">Price</label>
                                    <input type="number" step="1" min="1" id="inputPrice" name="price" value="{{ old('price') }}" class="form-control @error('price') is-invalid @enderror">
                                </div>
                                <div class="form-group">
                                    <label for="inputSerialNumber">Serial Number</label>
                                    <input type="text" id="inputSerialNumber" name="serial_number" value="{{ old('serial_number') }}" class="form-control @error('serial_number') is-invalid @enderror">
                                </div>
                                <div class="form-group">
