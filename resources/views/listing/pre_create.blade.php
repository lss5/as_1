...
<div class="row">
    <div class="col-12 col-lg-8 mx-auto">
        ...
        <hr class="py-1">
        <form method="POST" action="{{ route('profile.listing.create') }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <a href="{{ route('profile.listing.index') }}" class="btn btn-outline-secondary mx-1" role="button" aria-pressed="false">{{ __('product.btn.cancel') }}</a>
                </div>
            </div>
        </form>
    </div>
