                                        ...
                                        @foreach ($pages as $page)
                                            <tr>
                                                ...
                                                <td class="project-actions">
                                                    ...
                                                    <form action="{{ route('admin.pages.destroy', $page) }}" method="POST" class="form-inline d-inline">
                                                        @method('DELETE')
                                                        @csrf
                                                        <button type="submit" class="btn btn-sm btn-danger" onclick='return confirm("Delete page?");'>
