...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <form method="POST" action="{{ route('admin.pages.store') }}" enctype="multipart/form-data" class="w-100">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="inputListName" name="list_name" class="form-control  @error('list_name') is-invalid @enderror" value="{{ old('list_name') }}">
                                </div>
                                <div class="form-group">
